...
```bash
python ".cursor/skills/ui-ux-pro-max/scripts/search.py" "<query>" --domain <domain>
```
...
```bash
python ".cursor/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python ".cursor/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python ".cursor/skills/ui-ux-pro-max/scripts/search.py" "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
# Step 4: stack guidelines
python ".cursor/skills/ui-ux-pro-max/scripts/search.py" "suspense streaming bundle" --stack nextjs
```
