...
python .cursor/skills/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python .cursor/skills/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
